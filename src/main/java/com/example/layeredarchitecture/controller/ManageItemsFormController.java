...
public class ManageItemsFormController {
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
                ...
                //Save Item
                itemDAO.saveImpl(code,description,unitPrice,qtyOnHand);
            ...
            try {
                ...
                /*Update Item*/
                itemDAO.updateImpl(description,unitPrice,qtyOnHand,code);
    ...
    private String generateNewId() {
        try {
            ...
            if (itemId!=null) {
                int newItemId = Integer.parseInt(itemId.replace("I00-", "")) + 1;
